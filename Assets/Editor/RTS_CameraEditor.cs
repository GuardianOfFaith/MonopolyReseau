    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if (camera.limitMap)
            {
                ...
                camera.limitZ = EditorGUILayout.FloatField("Limit Y: ", camera.limitZ);
                camera.StartX = EditorGUILayout.FloatField("Min X: ", camera.StartX);
                camera.StartZ = EditorGUILayout.FloatField("Min Y: ", camera.StartZ);
            }
